...
<div class="container-fluid d-flex justify-content-center">
    ...
    <form action="" method="post" enctype="multipart/form-data" class="col-md-5">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" id="addTitle" class="form-control" name="addTitle" placeholder="Tytuł" value="{$book.0.title}">
            </div>
        </div>
        <div class="form-group row mt-2">
            <label for="addAuthor" class="col-sm-3 col-form-label">Autor</label>
            <div class="col-sm-9">
                <input type="text" id="addAuthor" class="form-control" name="addAuthor" placeholder="Autor" value="{$book.0.author}" >
            </div>
        </div>
        <div class="form-group row mt-2">
            <label for="totalPages" class="col-sm-3 col-form-label">Liczba stron</label>
            <div class="col-sm-9">
                <input type="number" id="totalPages" class="form-control" name="totalPages" placeholder="Liczba stron" value="{$book.0.pages}">
            </div>
        </div>
        <div class="form-group row mt-2">
            <label for="releaseDate" class="col-sm-3 col-form-label">Rok publikacji</label>
            <div class="col-sm-9">
                <input type="number" id="releaseDate" class="form-control" name="releaseDate" placeholder="Rok publikacji" value="{$book.0.year}">
            </div>
        </div>
        <div class="form-group row mt-2">
